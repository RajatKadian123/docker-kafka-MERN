...
// export const Host = () => {
//   // Inline CSS for the form background
//   const formStyle = {
//     background: 'url("offroad.png")',
...
//               <h2 className="text-center mb-4">Car Reservation Form</h2>
//               <div className="mb-3">
...
//                 <input type="text" className="form-control" id="carModel" placeholder="Enter car model" />
//               </div>
//               <div className="mb-3">
